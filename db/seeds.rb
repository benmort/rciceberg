...
Admin.create!(:email => "benjaminmort@gmail.com", :password => "turnkey", :password_confirmation => "turnkey")
Admin.create!(:email => "email.scottwarren@gmail.com", :password => "turnkey", :password_confirmation => "turnkey")